...
public class Gameplay {
    ...
    public void flow_of_game(GettingBasicDatas adatbeeski, ArrayList<Player> jatekos, RandomGen rand,Idiot buta, Genius okos)
    {
        for(int i=0;i<adatbeeski.num_of_turns;i++) {
            for(int t=0;t<adatbeeski.nDumb;t++) {
                jatekos.get(t).idiot_score();
